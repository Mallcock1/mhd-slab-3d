# -*- coding: utf-8 -*-
"""
Created on Mon Dec 19 14:56:16 2016
...
def root_find_scipy(func, root_list, x, y, step_size, x_values, old=True):
    x_values_new = []
    root_list_new = []
    if len(root_list) == 0:
    ...
    if old == True:
        ...
        return x_values_new, root_list_new
